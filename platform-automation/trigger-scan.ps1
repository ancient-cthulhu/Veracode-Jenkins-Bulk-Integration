...
.DESCRIPTION
    ...
    GitHub hourly on its own (PeriodicFolderTrigger, egress only) so new
    repos are discovered without this script. Use this script when you
    don't want to wait for the next hourly pass, or to trigger from a
